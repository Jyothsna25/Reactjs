  ...
  <div class="collapse navbar-collapse" id="div1">
    ...
    <li class="nav-item dropdown">
      ...
      <div class="dropdown-menu">       
        <Link class="dropdown-item" to="/ProductByCategory/Ring">Ring</Link>
        <Link class="dropdown-item" to="/ProductByCategory/Bracelet">Bracelet</Link>
        <Link class="dropdown-item" to="/ProductByCategory/chain">chain</Link>
